...
replacements = [
    ...
    ('<strong>Public Condemnation:</strong> Made strong public statements against Israeli military actions (e.g. "genocide", "apartheid") or faced personal/professional risk for speaking out, without formally joining an organised boycott.', '<strong>גינוי פומבי:</strong> הצהרות פומביות חזקות נגד פעולות ישראל (כגון: "רצח עם", "אפרטהייד") — מבלי הצטרפות רשמית לחרם מאורגן.'),
