...
replacements = [
    ...
    ('ArtSiren | Artist Boycott Database – 283 Verified Artists</title>', 'ArtSiren | מאגר אמנים המחרימים ישראל – 283 אמנים מאומתים</title>'),
    ('content="Search 283+ verified artists who support the cultural boycott of Israel. Roger Waters, Lorde, Dua Lipa, Brian Eno and more – all from publicly documented sources. Get instant alerts with our free Chrome extension."', 'content="חפש 283+ אמנים מאומתים התומכים בחרם התרבותי על ישראל. Roger Waters, Lorde, Dua Lipa, Brian Eno ועוד – הכל ממקורות מתועדים. קבל התראות מיידיות עם תוסף Chrome החינמי שלנו."'),
    ('og:title" content="ArtSiren | Artist Boycott Database – 283 Verified Artists"', 'og:title" content="ArtSiren | מאגר אמנים המחרימים ישראל – 283 אמנים מאומתים"'),
    ('og:description" content="Search 283+ verified artists who support the cultural boycott of Israel. All from publicly documented, mainstream media sources. Free Chrome extension for instant alerts."', 'og:description" content="חפש 283+ אמנים מאומתים התומכים בחרם התרבותי על ישראל. הכל ממקורות תקשורת מובילים. תוסף Chrome חינמי."'),
    ('"og:locale" content="en_US"', '"og:locale" content="he_IL"'),
    ('twitter:title" content="ArtSiren | Artist Boycott Database – 283 Verified Artists"', 'twitter:title" content="ArtSiren | מאגר אמנים המחרימים ישראל – 283 אמנים מאומתים"'),
    ('twitter:description" content="Search 283+ verified artists who support the cultural boycott of Israel. Roger Waters, Lorde, Dua Lipa, Brian Eno and more."', 'twitter:description" content="חפש 283+ אמנים התומכים בחרם התרבותי על ישראל. Roger Waters, Lorde, Dua Lipa, Brian Eno ועוד."'),
    ...
    ('⚡ Add Chrome Extension', '⚡ הוסף תוסף לכרום'),
    ('⚡ Extension', '⚡ תוסף'),
    ('\U0001f4f1 Install App', '\U0001f4f1 התקן אפליקציה'),
    ('Verified &amp; Source-Backed', 'מאומת ומגובה במקורות'),
    ('<h1>Artist <span>Boycott</span> Database</h1>', '<h1>מאגר אמנים <span>המחרימים</span> ישראל</h1>'),
    ('>Know Before You Go<', '>דע לפני שאתה הולך<'),
    ('>+ verified artists from publicly documented, mainstream media sources.<', '>+ אמנים מאומתים ממקורות תקשורת מובילים ומתועדים.<'),
    ('>Last updated: May 2026<', '>עודכן לאחרונה: מאי 2026<'),
